...
use CatalogueBundle\Entity\Rate;
...
class RateController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $rates = $em->getRepository('CatalogueBundle:Rate')->findAll();
    ...
    {
        $rate = new Rate();
        $form = $this->createForm('CatalogueBundle\Form\RateType', $rate);
    ...
    {
        $deleteForm = $this->createDeleteForm($rate);
        $editForm = $this->createForm('CatalogueBundle\Form\RateType', $rate);
